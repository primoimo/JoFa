...
function saveTestimonial(i) {
  ...
  renderAdminTab('testemunhos'); renderTestimonials(); showToast('✅ Testemunho salvo!');
}
...
function saveReuniao(i) {
  ...
  renderAdminTab('reunioes'); renderReunioes(); updateLastReuniao(); showToast('✅ Reunião salva!');
}
...
function saveGalleryItem(i) {
  ...
  renderGallery(); showToast('✅ Foto salva!');
}
...
function saveEvent(i) {
  ...
  renderAdminTab('agenda'); renderEvents(); showToast('✅ Evento salvo!');
}
